...
# ðŸ“© DM for permission : @TheSigmaCoder
# =======================================================
        ...
        if name[0:3] == "sud":
            ...
            if await is_on_off(2):
                return await app.send_message(
                    ...
                    text=f"âœ¦ {message.from_user.mention} á´Šá´œsá´› sá´›á´€Ê€á´›á´‡á´… á´›Êœá´‡ Ê™á´á´› á´›á´ á´„Êœá´‡á´„á´‹ <b>sá´œá´…á´ÊŸÉªsá´›</b>.\n\n<b>âœ¦ á´œsá´‡Ê€ Éªá´… âž </b> <code>{message.from_user.id}</code>\n<b>âœ¦ á´œsá´‡Ê€É´á´€á´á´‡ âž </b> @{message.from_user.username}",
                )
            return
...
# ======================================================
# Â©ï¸ 2025-26 All Rights Reserved by Purvi Bots (Im-Notcoder) ðŸ˜Ž

# ðŸ§‘â€ðŸ’» Developer : t.me/TheSigmaCoder
# ðŸ”— Source link : GitHub.com/Im-Notcoder/Purvi-V3
# ðŸ“¢ Telegram channel : t.me/Purvi_Bots
# ======================================================
