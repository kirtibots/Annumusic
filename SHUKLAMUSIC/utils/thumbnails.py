...
async def get_thumb(videoid: str) -> str:
    ...
    try:
        title_font = ImageFont.truetype("KRITI_MUSIC/assets/font2.ttf", 32)
        regular_font = ImageFont.truetype("KRITI_MUSIC/assets/font.ttf", 18)
    except OSError:
    ...
    # Icons
    icons_path = "KRITI_MUSIC/assets/play_icons.png"
